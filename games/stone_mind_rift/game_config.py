...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        pay_group = {
            (r1, "L1"): 0.2, (r2, "L1"): 0.6, (r3, "L1"): 1.5,
            (r1, "L2"): 0.3, (r2, "L2"): 0.8, (r3, "L2"): 2.5,
            (r1, "L3"): 0.4, (r2, "L3"): 1.0, (r3, "L3"): 4.0,
            (r1, "L4"): 0.6, (r2, "L4"): 1.2, (r3, "L4"): 6.0,
            (r1, "H1"): 0.8, (r2, "H1"): 1.5, (r3, "H1"): 8.0,
            (r1, "H2"): 1.0, (r2, "H2"): 2.0, (r3, "H2"): 10.0,
            (r1, "H3"): 1.5, (r2, "H3"): 4.0, (r3, "H3"): 15.0,
            (r1, "H4"): 2.0, (r2, "H4"): 8.0, (r3, "H4"): 20.0,
            (r1, "H5"): 5.0, (r2, "H5"): 15.0, (r3, "H5"): 50.0,
        }
                ...
                distributions=[
                    Distribution(
                        ...
                        conditions={
                            ...
                            "mult_values": {
                                self.basegame_type: {10: 30, 20: 25, 50: 15, 100: 10, 200: 8, 500: 7, 1000: 5},
                                self.freegame_type: {10: 30, 20: 25, 50: 15, 100: 10, 200: 8, 500: 7, 1000: 5},
                            },
                        },
                    ),
                    Distribution(
                        ...
                        conditions={
                            ...
                            "mult_values": {
                                self.basegame_type: {1: 40, 2: 25, 3: 15, 5: 8, 10: 5, 20: 3, 50: 2, 100: 1, 200: 1},
                                self.freegame_type: {1: 40, 2: 25, 3: 15, 5: 8, 10: 5, 20: 3, 50: 2, 100: 1, 200: 1},
                            },
                        },
                    ),
                ],
